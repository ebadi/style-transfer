...
# ── 1. Base checkpoint: Realistic Vision V5.1 ──
echo "[1/6] Realistic Vision V5.1 (~2.1 GB)"
download \
...
echo "[2/6] ControlNet canny (~0.7 GB)"
download \
...
echo "[3/6] IP-Adapter Plus SD1.5 (~0.3 GB)"
download \
...
echo "[4/6] CLIP Vision ViT-H (~2.4 GB)"
download \
...
# ── 6. AnimateDiff v3 motion module (temporal consistency) ──
echo "[6/6] AnimateDiff v3 motion module (~1.7 GB)"
download \
    "$HF/guoyww/animatediff/resolve/main/mm_sd15_v3.safetensors" \
    "$MODELS_DIR/animatediff_models/mm_sd15_v3.safetensors"

echo ""
echo "All models downloaded to $MODELS_DIR"
echo "You can now run: docker compose --profile inference up"
